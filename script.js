...
const translations = {
  vi: {
    ...
    optDesign: 'Thiết kế',
    hotJobsTitle: 'VIỆC LÀM <span class="highlight">NỔI BẬT</span>',
    // hotJobsSubtitle: 'Những cơ hội việc làm được quan tâm nhiều nhất',
    btnApplyNow: 'Ứng tuyển ngay',
    btnSeeMoreHot: 'Xem thêm việc làm nổi bật',
    featuredJobsTitle: 'VIỆC LÀM <span class="highlight">HOT</span>',
    // featuredJobsSubtitle: 'Cập nhật những cơ hội việc làm mới nhất',
    badgeNew: 'Mới',
    btnApply: 'Ứng tuyển',
    btnSeeMore: 'Xem thêm việc làm Hot',
    ...
    footerDesc: 'Giải pháp karaoke hoàn hảo.',
  ...
  en: {
    ...
    ctaBtn: 'Post a Job',
    footerDesc: 'The perfect karaoke solution.',
